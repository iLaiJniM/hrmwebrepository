...
<div style="margin: auto; width: 60%">
    ...
    <div style="margin: auto; width: 90%;background-color: aquamarine">
        <form action="updatePosition" method="post">
            <input name="department_id" type="hidden" value="${requestScope.department_id}">
            <input name="position_id" type="hidden" value="${requestScope.position.position_id}">
            <table width="800" border="1" align="center" cellpadding="10" cellspacing="0">
                <caption><h1>职 位 更 名</h1></caption>
                <tr>
                    <td colspan="3" bgcolor="#9FCDEA" align="center">
                        职 位 名 称 ：<input name="position_name" value="${requestScope.position.position_name}">
                    </td>
                </tr>
            </table><br/><br/>

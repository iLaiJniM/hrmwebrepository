...
<div style="margin: auto; width: 60%">
    ...
    <div style="margin: auto; width: 90%;background-color: aquamarine">
        <form action="updateDepartment" method="post">
            <input type="hidden" name="department_id" value=${requestScope.department.department_id}>
            <table width="800" border="1" align="center" cellpadding="10" cellspacing="0">
                <caption><h1>部 门 更 名</h1></caption>
                <tr>
                    <td colspan="3" bgcolor="#9FCDEA" align="center">
                        部 门 名 称 ：<input name="department_name" value=${requestScope.department.department_name}>
                    </td>
                </tr>
            </table><br/><br/>
